             ...
             <div className="flex justify-between items-start mb-12 print:mb-8">
                 <div className="flex flex-col gap-2">
                     <div className="flex items-center gap-3">
                         ...
                         <h1 className="text-2xl font-bold tracking-tight uppercase">{settings.businessName || 'Mi Negocio'}</h1>
                     </div>
                     <div className="text-gray-500 text-xs mt-2 space-y-0.5">
                         <p className="font-bold text-gray-900">{settings.businessName}</p>
                 ...
                 <div className="text-right">
                     ...
                     <div className="flex flex-col items-end gap-1">
                        <div className="flex items-center gap-4">
                            <span className="text-gray-500 uppercase text-[10px] font-bold tracking-wider">Nº Operación</span>
             ...
             <div className="fixed bottom-10 left-10 right-10 border-t border-gray-200 pt-6 print:absolute print:bottom-8">
                 <div className="flex justify-between items-end text-xs text-gray-500">
                     <div className="space-y-1">
                         <p className="font-bold text-gray-900 text-sm">¡Gracias por su compra!</p>
